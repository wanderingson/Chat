	...
	class ReceiveInfo extends Thread { 
		...
		public void run() {
			try {
				...
				serverchatgui.UserList.setText(null);
				serverchatgui.AppendUserList(NickNameList);
//				serverchatgui.AppendMessage("알림 : " + NickName + "님이 입장하셨습니다.\n");
				Transmitall("알림 : " + NickName + "님이 입장하셨습니다.\n");
...
//				Transmitall("알림 : " + NickName + "님이 입장하셨습니다.\n");
				...
				serverchatgui.AppendMessage("알림 : " + NickName + "님이 퇴장하셨습니다.\n");
				//Transmitall("알림 : " + NickName + "님이 퇴장하셨습니다.\n");
				for (int i = 0; i < NickNameList.size(); i++) {
					Transmitall("+++닉네임의시작+++" + NickNameList.get(i));
				}
				Transmitall("알림 : " + NickName + "님이 퇴장하셨습니다.\n");
